...
def draw():
    ...
    r0 = rg_rect(mouse_x, mouse_y, 100, 100, QUARTER_PI)
    r1 = rg_rect(mouse_x, -mouse_y, 100, 100, 0)
    r2 = rg_rect(-mouse_x, -mouse_y, 100, 100, QUARTER_PI / 2)
    r3 = rg_rect(-mouse_x, mouse_y, 100, 100)
